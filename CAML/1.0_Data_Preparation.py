...
if True:  # __name__ == '__main__':
    ...
    files = natsorted(
        [
            ...
            if os.path.isfile(os.path.join(output_folder, i))
    ...
    for fileIdx in range(starting_index, finishing_index):
        ...
        datatable = np.genfromtxt(
            os.path.join(output_folder, current_file),
        ...
        ps["TableHeaders"] = ps["TableHeaders"].replace(
            '"', ""
        )  # clean up headers for legibility
        ...
        if doAddUID:
            ...
            ps["TableHeaders"] = (
                ps["TableHeaders"] + ps["InputFileDelimiter"] + "pointUID"
            )
        ...
        if not "LabelIDCol" in ps and prepType == "training":
            ...
            ps["TableHeaders"] = (
                ps["TableHeaders"] + ps["InputFileDelimiter"] + "Class Label"
            )
            print(
