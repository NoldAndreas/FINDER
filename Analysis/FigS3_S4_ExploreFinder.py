...
for dbscanType in ["DbscanLoop", "dbscan"]:
    for name_idx in ["FigS3", "FigS4"]:
        ...
        if name_idx == "FigS4":
            ...
            # "Clusters_DNA_1mers";#"Clusters_Neuron";
        ...
        XC = G.XC
        FD = Finder(
            algo=dbscanType  # ,threshold=threshold,points_per_dimension=points_per_dimension
            # , one_two_d="oneD"
        ...
        plt.savefig(
            basefolder + name + "_selection_process.pdf", bbox_inches="tight"
        )
        plt.show()
