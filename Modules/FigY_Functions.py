...
def DefineCleanedLabels(df_clusterSizes_all,phasespace_all,criterion,bestRequiredRate,generalLimit=True):
...
def PlotScatter(XC_,labels=[],ax=[],scalebar=False):
    ...
    if(scalebar == True):
        ...
        ax.text(x+d/2,y+delta_xy[1]/40,'500nm',ha='center', va='center');
