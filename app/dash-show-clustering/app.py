                        ...
                        html.Div(
                            ...
                            children=[
                                dcc.Loading(
                                    ...
                                    children=dcc.Graph(
                                        id="graph-phasespace",
                                        figure=figs.make_default_figure(),
                                    ),
                                    style={},
                                ),
                                dcc.Loading(
...
def update_scatterplot(clickData, show_clusters, window, dataset):
    ...
    if dataset and window:
        ...
        if clickData and show_clusters:
            ...
            figure_scatterplot = figs.serve_scatterplot(
                CB.XC_incell, ps["labels"]
            )
        else:
        ...
        return html.Div(
            ...
            children=[
                dcc.Loading(
                    ...
                    children=dcc.Graph(
                        id="graph-scatter", figure=figure_scatterplot
                    ),
                    style={"display": "none"},
                ),
            ],
...
def update_svm_graph(
    dataset, window, quantity, quantity_statistics, change_threshold
):
    if dataset and window:
        outputfolder_window = os.path.join(BASEDIR, dataset, "Output", window)
        ...
        figure_along_optima = figs.serve_along_optima_figure(
            CB, l[0], change_threshold=change_threshold
        )
